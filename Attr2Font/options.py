...
def get_parser():
    ...
    # Orig
    parser.add_argument("--attrB", type=str, default="attrB.csv")
    parser.add_argument("--genImg_epoch", type=int, default=500, help='epoch to generate image')
    parser.add_argument("--attributes_file", type=str, default="attributes.txt")
    parser.add_argument("--fine_tune_dir", type=str, default='None')
    parser.add_argument("--fine_tune_init_epoch", type=int, default=1)
    parser.add_argument("--style_char_file", type=str, default='None')

    ## Test_Opts
    parser.add_argument("--load_weight_path", type=str, default='default')
    parser.add_argument("--test_num", type=int, default=3)
    parser.add_argument("--fix_index", type=int, default=0)
    ...
    parser.add_argument("--phase", type=str, default='train', choices=['train', 'test', 'test_interp', 'gen_img'], help='mode')
